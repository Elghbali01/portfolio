      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 py-16">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-bold">
            All <span className="text-[#3B82F6]">Certifications</span>
          </h1>
          <p className="text-[#94A3B8] mt-4 max-w-2xl mx-auto">
            A complete collection of my professional certifications and credentials.
          </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {certifications.map((cert, index) => (
            <CertificationCard
              ...
              index={index}
              variant="full"
              onImageClick={(c) => setPreviewCert(c)}
            />
          ))}
        </div>
