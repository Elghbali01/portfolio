...
const FRENCH = /\b(?:bonjour|bonsoir|salut|pourquoi|comment|qui|pr[eé]sente|r[eé]sume|ann[eé]e|obtenu|profil|poste|serait|adapt[eé]|int[eé]ressant|projets?|comp[eé]tences?|certif(?:icat)?s?|voir|montre|affiche|ouvre|donne(?:r)?|quel(?:le)?s?|parle|num[eé]ro|t[eé]l[eé]phone|email|courriel|localisation|adresse|peux|chercher|ailleurs|information|portfolio|fran[cç]ais)\b/i;
